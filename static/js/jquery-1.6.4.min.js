...
(function (a, b) {
          ...
          return f.Deferred(function (d) {
            f.each({
              ...
              f.isFunction(e) ? b[a](function () {
                ...
                h && f.isFunction(h.promise) ? h.promise().then(d.resolve, d.reject)  : d[g + 'With'](this === b ? d : this, [
                  h
                ])
              })  : b[a](d[g])
            })
  ...
  be.th = be.td,
  f.support.htmlSerialize || (be._default = [
    1,
    'div<div>',
    '</div>'
  ]),
    ...
    animate: function (a, b, c, d) {
      ...
      return this[e.queue === !1 ? 'each' : 'queue'](function () {
        ...
        for (i in a) {
          ...
          ], f.css(this, 'display') === 'inline' && f.css(this, 'float') === 'none' && (f.support.inlineBlockNeedsLayout ? (j = cr(this.nodeName), j === 'inline' ? this.style.display = 'inline-block' : (this.style.display = 'inline', this.style.zoom = 1))  : this.style.display = 'inline-block'))
        }
